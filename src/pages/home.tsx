...
import bc1 from "@/assets/img/bc2.png";
      ...
      <IndexBox>
        ...
        <ModuleItem title={"Our Values"} subTitle={"The Pillars of BabyShib"}>
          <Value1>
            ...
            <ValueBox>
              <h2>Community</h2>
              <p>
                After gaining substantial traction on the Shibarium network and
                BSC chain, BabyShib has amassed a powerful following, forming
                the bedrock of our success. BabyShib is poised to emerge as the
                new champion on the Solana blockchain.
              </p>
        ...
        <TokenomicsBox>
          ...
          <TokenomicsItem>
            ...
            <div className="value">
              0% {/* <span className="percentage">0% Fee on ETH</span> */}
            </div>
          </TokenomicsItem>{" "}
          <TokenomicsItem>
        ...
        <TokenomicsBox2>
          <TokenomicsRectangle>
            <h3>
              {" "}
              BABYSHIB: The Rising Star of Shibarium Network and BSC Chain
            </h3>
            <p>
              As a proud member of the Shiba Inu family with an unparalleled
              pedigree, BABYSHIB has emerged as a standout figure. Born on the
              Shibarium network, its pure lineage, innovative spirit, and
              unwavering community support have caused ripples in the crypto
              space.
            </p>
          </TokenomicsRectangle>
          <TokenomicsRectangle2>
